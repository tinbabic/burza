    ...
    // volume bar chart
      ...
      barchart.append("g")
              .attr("clip-path", "url(#chart-area)")
                ...
                .attr("y", function(d){ return yBarScale(d.volume);})
                .attr("width", 15)
                .attr("height", function(d){ return barHeight - yBarScale(d.volume);})
                .attr("fill","steelblue")/*
      ...
      barchart.append("g")
        ...
        function brushed(){
          ...
          xScale.domain(d3.event.selection===null ? x2.domain() : 
                  [x2.invert(d3.event.selection[0]),x2.invert(d3.event.selection[1])]);
          
          //console.log(xScale.invert(d3.event.selection[1]));
          d3.select(".line").attr("d", dataLine);
